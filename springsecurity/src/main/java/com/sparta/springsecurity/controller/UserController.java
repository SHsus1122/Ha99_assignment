...
public class UserController {
    ...
    // 스프링 시큐리티는 SecurityContext 에 인증된 Authentication 객체를 넣어두고 현재 스레드 내에서 공유되도록 관리한다.
    // AuthenticationPrincipal 는 인증 이후 현재 인증된 세션유저를 가져오기 위해서 사용하는 어노테이션이다.
    @PostMapping("/login")
